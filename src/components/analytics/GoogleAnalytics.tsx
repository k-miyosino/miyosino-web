...
console.log('[GA Debug] NEXT_PUBLIC_GA_MEASUREMENT_ID (env):', envMeasurementId || '(empty/undefined)');
...
export function GoogleAnalytics() {
  console.log('[GA Debug] GoogleAnalytics component rendering, measurementId:', measurementId);
  ...
  return (
    <>
      <Script
        ...
        onLoad={() => console.log('[GA Debug] gtag.js script loaded successfully')}
        onError={() => console.error('[GA Debug] gtag.js script failed to load')}
      />
